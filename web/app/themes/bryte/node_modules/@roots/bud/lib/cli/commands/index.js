...
export default class BudCommand extends Command {
     ...
     */
    renderStatic(el) {
        return this.render(_jsx(Ink.Static, { items: [0], children: (e, i) => _jsx(Ink.Fragment, { children: el }, i) }));
    }
    /**
    ...
    async applyUserOptions(bud) {
        await Promise.all([
            ...
            [
                ...
                `BUD_USE`,
                undefined,
                b => async (v) => await b.extensions.add(v),
            ],
        ].map(this.override));
    }
    /**
    ...
    async catch(error) {
        ...
        this.render(_jsx(Dash.Error, { error: error }));
